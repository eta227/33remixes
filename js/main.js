...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/marina_a.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer17);
...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/marina_b.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer18);
...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/ludmila_a.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer19);
...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/ludmila_b.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer20);
...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/lollipop01.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer21);
...
// now init one as an example
var cap = new CircleAudioPlayer({
    audio: 'sound/lollipop02.mp3',
    size: 45,
    borderWidth: 5,
});
cap.appendTo(playerContainer22);
